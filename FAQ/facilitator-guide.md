...
- [README](../README.md) - Full curriculum overview
- [Participant Quickstart](participant-quickstart.md) - Share with attendees before training
- [IDE Support](IDE-support.md) - Feature availability by IDE (Training is via VS Code)
