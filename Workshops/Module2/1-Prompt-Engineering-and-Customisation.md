...
- Complete the [Module 2 Lab](3-Module2-Lab.md) to practice customising your Copilot experience
- Review [Module 2 Prompts](4-Module2-Prompts.md) for additional prompt examples
