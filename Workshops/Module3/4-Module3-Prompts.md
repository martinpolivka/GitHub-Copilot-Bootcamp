# GitHub Copilot Prompt Examples - Module 3: MCP and GitHub Copilot
...
After mastering MCP integration with GitHub Copilot in Module 3, we will explore DevOps automation, testing strategies, and GitHub Copilot CLI workflows in Module 4 to streamline software delivery.

**[← Back to Main README](../../README.md)** | **[Continue to Module 4 →](../Module4/1-DevOps-Automation.md)**
