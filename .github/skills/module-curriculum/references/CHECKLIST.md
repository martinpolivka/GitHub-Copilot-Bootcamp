# Module Curriculum Scaffolding Checklist

Run through every item before reporting the new module as done. Fix any failure before finishing.

## Folder and files

- [ ] `Workshops/Module{{MODULE_NUMBER}}/` exists and contains exactly four markdown files.
- [ ] File names follow the pattern `1-Title.md`, `2-Title.md`, `3-Module{{MODULE_NUMBER}}-Lab.md`, `4-Module{{MODULE_NUMBER}}-Prompts.md`.
...
- [ ] Suggested git commit message of the form `Add Module {{MODULE_NUMBER}}: {{MODULE_TITLE}}`.
